...
export function buildDemoData(companyId: string) {
  ...
  const projects: Project[] = [
    { id: newId(), ...base, name: "Northwind Rebrand", client_id: clients[0].id, status: "In Progress", progress: 68, deadline: daysFromNow(9), budget: 180000 },
    { id: newId(), ...base, name: "Arcadia App Redesign", client_id: clients[1].id, status: "In Progress", progress: 85, deadline: daysFromNow(3), budget: 320000 },
    { id: newId(), ...base, name: "Blue Summit Ops Dashboard", client_id: clients[2].id, status: "At Risk", progress: 20, deadline: daysAgo(2), budget: 210000 },
    { id: newId(), ...base, name: "Everline Launch Trailer", client_id: clients[3].id, status: "Planning", progress: 5, deadline: daysFromNow(21), budget: 95000 },
    { id: newId(), ...base, name: "Northwind SEO Overhaul", client_id: clients[0].id, status: "Completed", progress: 100, deadline: daysAgo(12), budget: 60000 },
  ];
